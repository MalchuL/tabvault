...
class WarningDTO(BaseModel):
    ...
    Attributes:
        ...
        path (str): Path to the stored asset or backup file.
...
class IssueDTO(WarningDTO):
    ...
    Attributes:
        expected (str): Expected value or contract shape.
        received (Any): Actual value received from the caller.
        http_status (int): HTTP status returned for this problem.
        suggested_fix (str | None): Safe action suggested to resolve the error.
    """
