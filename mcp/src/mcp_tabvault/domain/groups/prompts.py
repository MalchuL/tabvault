...
list_tabs and get_tab. Produce a {format} research digest for a {audience} audience. Organize the
material by theme, preserve original URLs, distinguish saved metadata from your inferences, and
mention important gaps. Do not change the library."""
