...
/**
 * Attach keyboard-accessible contextual help to a small marker.
 * @param {ContextHelpProps} props - Title, explanation, optional tip, and placement.
 * @returns {JSX.Element} Help trigger and tooltip content.
 */
