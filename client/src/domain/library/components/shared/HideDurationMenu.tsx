...
/**
 * Offer preset hide or prolong durations for a tab or group.
 * Closes the popover after passing the selected duration to its owner.
 * @param {{ mode: "hide" | "prolong"; target: string; onSelect: (durationMs: number) => void }} props - Action label, target, and duration handler.
 * @returns {JSX.Element} Trigger and duration choices.
 */
